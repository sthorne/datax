...
var (
	...
	PlacementMoves = promauto.With(Registry).NewCounter(prometheus.CounterOpts{
		Name: "datax_placement_replicas_moved_total", Help: "Replicas moved onto nodes their database's placement policy admits.",
	})
